                ...
                <div class="row">
                  ...
                  <div class="col-md-12">
                    ...
                    <div class="card card-primary">
                      ...
                      <!-- /.card-header -->
                      <!-- form start -->
                      <form method="post" action="{{url('software/'.$id)}}"enctype="multipart/form-data">
                        @csrf
                        {{method_field('PUT')}}
                        <div class="card-body">
                          ...
                          <div class="form-group">
                            ...
                            <input type="date" name="tgl_ex" class="form-control" id="tanggal" placeholder="tanggal" value="{{$data->tgl_ex}}">
                          </div>
                          <div class="form-group">
                            <label for="link">link</label>
                            <input type="text" name="link" class="form-control" id="link" placeholder="link" value="{{$data->link}}">
                          </div>
                        </div>
                        <!-- /.card-body -->
