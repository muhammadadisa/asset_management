                ...
                <div class="row">
                  ...
                  <div class="col-md-12">
                    ...
                    <div class="card card-primary">
                      ...
                      <!-- /.card-header -->
                      <!-- form start -->
                      <form method="post" action="{{route('sdm.store')}}"enctype="multipart/form-data">
                        @csrf
                        <div class="card-body">
                          ...
                          <div class="form-group">
                            ...
                            <input type="text" name="bidang" class="form-control" id="bidang" placeholder="bidang">
                          </div>
                          <div class="form-group">
                          ...
                          <div class="form-group">
                            ...
                            <input type="text" name="seksi" class="form-control" id="seksi" placeholder="seksi">
                          </div>
                          <div class="form-group">
                          ...
                          <div class="form-group">
                            ...
                            <input type="number" name="kontak" class="form-control" id="kontak" placeholder="kontak">
                          </div>
                          <div class="form-group">
